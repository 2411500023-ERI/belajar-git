...
--
-- Host: localhost:3306
-- Generation Time: Oct 08, 2025 at 01:14 PM
...
ALTER TABLE `buku_kategori`
  ADD KEY `buku_id_kategori` (`id_buku`),
...
--
ALTER TABLE `peminjaman`
  ADD CONSTRAINT `id_buku` FOREIGN KEY (`id_buku`) REFERENCES `buku` (`id_buku`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
